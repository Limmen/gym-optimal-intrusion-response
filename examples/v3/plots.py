...
def parse_data(base_path_1: str, base_path_2: str, suffix: str, ips = None, eval_ips = None):
    ...
    ppo_v3_df_3410 = pd.read_csv(glob.glob(base_path_1 + "3410/*_train.csv")[0])
    ...
    ppo_dfs_v2 = [ppo_v2_df_299, ppo_v2_df_41239]
    ...
    avg_train_rewards_stds_v3 = avg_train_rewards_stds_v3 + 15
