...
from gym_optimal_intrusion_response.agents.openai_baselines.common import logger
from gym_optimal_intrusion_response.agents.openai_baselines.common.base_class import BaseAlgorithm
from gym_optimal_intrusion_response.agents.openai_baselines.common.buffers import ReplayBuffer
from gym_optimal_intrusion_response.agents.openai_baselines.common.callbacks import BaseCallback
from gym_optimal_intrusion_response.agents.openai_baselines.common.noise import ActionNoise
from gym_optimal_intrusion_response.agents.openai_baselines.common.policies import BasePolicy
from gym_optimal_intrusion_response.agents.openai_baselines.common.save_util import load_from_pkl, save_to_pkl
from gym_optimal_intrusion_response.agents.openai_baselines.common.type_aliases import GymEnv, MaybeCallback, RolloutReturn, Schedule, TrainFreq, TrainFrequencyUnit
from gym_optimal_intrusion_response.agents.openai_baselines.common.utils import safe_mean, should_collect_more_steps
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    :param attacker_policy: Policy object
    :param env: The environment to learn from
                (if registered in Gym, can be str. Can be None for loading trained models)
    :param policy_base: The base policy used by this method
    :param attacker_learning_rate: learning rate for the optimizer,
    ...
    :param attacker_policy_kwargs: Additional arguments to be passed to the policy on creation
